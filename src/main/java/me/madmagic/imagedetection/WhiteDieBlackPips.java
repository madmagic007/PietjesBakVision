...
public class WhiteDieBlackPips extends ImageDetection {

    public WhiteDieBlackPips() {
        params.put("blur", 19);

        params.put("contourMinCanny", 0);
        params.put("contourMaxCanny", 60);
        params.put("contourKernelSize", 7);
        params.put("contourMinArea", 15000);
        params.put("contourFrames", 10);

        params.put("blackHatKernelSize", 30);
        params.put("blackHatThresh", 100);

        params.put("pipMinArea", 200);
        params.put("pipMaxArea", 500);
        params.put("pipMinCircularity", 70);
        params.put("pipMaxDist", 70);
